...
'''
0    P01 is a set of 10 weights and profits for a knapsack of capacity 165.
1    P02 is a set of 5 weights and profits for a knapsack of capacity 26.
2    P06 is a set of 7 weights and profits for a knapsack of capacity 170. The knapsack can be packed to an optimal weight of 169.
3    P07 is a set of 15 weights and profits for a knapsack of capacity 750, from Kreher and Stinson, with an optimal profit of 1458.
4    P08 is a set of 24 weights and profits for a knapsack of capacity 6404180, from Kreher and Stinson, with an optimal profit of 13549094.
'''
...
def main():
    ...
    for iter in range(150):
        ...
        for ant_num in range(ant_count):
            ...
            while(capacity>=0):
                chosen_obj = [((pheromone_track[item])**alfa) * ((heuristic_info(weight[item], profit[item], capacity_org)) ** beta) if availability[item] == True else 0 for item in range(len(weight))]
